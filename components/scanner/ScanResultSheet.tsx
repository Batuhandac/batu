...
export function ScanResultSheet({
  ...
  useEffect(() => {
    if (visible) {
      ...
      translateY.value = withTiming(SHEET_H, { duration: 250 });
    }
  }, [visible, translateY]);
            ...
            <View style={styles.cardInfo}>
              ...
              <View style={styles.confidence}>
                <Badge
                  ...
                  variant={confidence >= 0.9 ? 'success' : 'warning'}
                />
              </View>
            </View>
          </View>
          ...
          {price && (
            <View style={styles.priceBox}>
              ...
              <View style={styles.priceRow}>
                ...
                <PriceCol label="Orta" usd={price.mid} highlight />
          ...
          <View style={styles.section}>
            ...
            <View style={styles.conditionRow}>
              {CONDITIONS.map((c) => (
                ...
                >
                  <Text
                    style={[styles.conditionLabel, c === condition && styles.conditionLabelActive]}
                  >
                    {c}
                  </Text>
                </Pressable>
